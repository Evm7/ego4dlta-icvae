...
# -----------------------------------------------------------------------------
# CVAE options (added by EsteveValls)
# -----------------------------------------------------------------------------
_C.TEST.SPLIT = "test"
...
_C.CVAE.latent_dim= 128 #1024 #256
_C.CVAE.modelname= "cvae_transformer_rc_rcxyz_kl"
_C.CVAE.modeltype= "cvae"
_C.CVAE.nfeats= 14
_C.CVAE.num_actions_to_predict= 20
_C.CVAE.num_epochs= 1000
_C.CVAE.num_input_clips= 2
_C.CVAE.num_intentions= 136
_C.CVAE.num_layers= 4
_C.CVAE.num_nouns= 478
_C.CVAE.num_verbs=  115
_C.CVAE.sampling= "conseq"
_C.CVAE.topK= 5
_C.CVAE.semantic_dim= 768
_C.CVAE.shared_embedding= True
_C.CVAE.conditions_decoder = "input_as_data" # "input_as_memory"
_C.CVAE.pair_embedding = False
_C.CVAE.heads_per_future = True
_C.CVAE.separate_nouns_verbs = False
...
_C.MLPMixer = CfgNode()
_C.MLPMixer.num_intentions = 136
_C.MLPMixer.feature_dimension = 2304
_C.MLPMixer.num_features = 14
_C.MLPMixer.depth = 4
_C.MLPMixer.expansion_factor_token = 0.5
_C.MLPMixer.expansion_factor = 4
_C.MLPMixer.dropout_rate = 0.2
_C.MLPMixer.num_actions_classes = [115, 478]
_C.MLPMixer.noise_injection_mean = 0.0
_C.MLPMixer.noise_injection_std = 0.3
_C.MLPMixer.noise_injection_factor = 0.01
_C.MLPMixer.imbalanced = False
_C.MLPMixer.beta = 0.9
_C.MLPMixer.double_mixer = True
_C.MLPMixer.action_loss = False
_C.MLPMixer.augmentation = False
...
# LOSSES TO THE MODEL
_C.MODEL.lambdas = CfgNode()
_C.MODEL.lambdas.kl= 1.0e-05
_C.MODEL.lambdas.l2= 1.0
_C.MODEL.lambdas.cross_entropy= 1.0

_C.MODEL.losses = ["rc", "rcxyz", "kl"]
